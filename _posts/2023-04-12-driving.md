...
Pass the Basic Theory Test (BTT) at any of the driving centers in Singapore;
Possess a valid qualified foreign driving license
Possess an extract of the driving license record from the Licensing Authority, indicating the date of first issue of the foreign driving license and the date of expiry of the driving license
Possess a valid International Driving Permit (IDP)

For those without a foreign driving license…

… it’s a bit more drawn out.
Register at a driving center
Pass an eye and colour test
Pass the Basic Theory Test (BTT): 50 questions, 50 minutes, 45/50 to pass
Pass the Final Theory Test (FTT):  50 questions, 50 minutes, 45/50 to pass; only after you pass your BTT
Begin on-road driving classes: at a driving school or through private classes
Complete three driving simulator sessions: only after 5 on-road classes. These simulators are like the driving games you get in arcades except they’re miles slower and a lot more educational
Pass the Practical Driving Test (PDT). Assessment components include -
Circuit test: Complete various stations at a designated circuit to test parallel parking, vertical parking, directional change, emergency stop, moving up slope, moving up a ramp, navigating a crank course, navigating a S-course. There’s no specific ordering for these stations - it’s dependent on the traffic conditions inside the circuit
Road test: Drive on-road to test steering control, road etiquette, lane change and u-turns
...
Comfort DelGro Driving Center (CDC) - in Ubi (the East)
Singapore Safety Driving Center (SSDC) - in Woodlands (the North)
Bukit Batok Driving Center (BBDC) - in Bukit Batok (the West)
